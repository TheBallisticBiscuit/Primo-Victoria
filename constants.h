...
const int ARCHER_IDLE_RIGHT_END = 0;
const int ARCHER_IDLE_UP_START = 9;
const int ARCHER_IDLE_UP_END = 9;
const int ARCHER_IDLE_DOWN_START = 18;
const int ARCHER_IDLE_DOWN_END = 18;
const int ARCHER_IDLE_LEFT_START = 27;
const int ARCHER_IDLE_LEFT_END = 27;
const int ARCHER_RUN_RIGHT_START = 36;
const int ARCHER_RUN_RIGHT_END = 36;
const int ARCHER_RUN_UP_START = 44;
const int ARCHER_RUN_UP_END = 44;
const int ARCHER_RUN_DOWN_START = 52;
const int ARCHER_RUN_DOWN_END = 52;
const int ARCHER_RUN_LEFT_START = 60;
const int ARCHER_RUN_LEFT_END = 60;
const int ARCHER_ATTACK_RIGHT_START = 68;
const int ARCHER_ATTACK_RIGHT_END = 68;
const int ARCHER_ATTACK_UP_START = 81;
const int ARCHER_ATTACK_UP_END  = 81;
const int ARCHER_ATTACK_DOWN_START = 94;
const int ARCHER_ATTACK_DOWN_END = 94;
const int ARCHER_ATTACK_LEFT_START = 107;
const int ARCHER_ATTACK_LEFT_END = 107;
const int ARCHER_DEATH_RIGHT_START = 120;
const int ARCHER_DEATH_RIGHT_END = 120;
const int ARCHER_DEATH_UP_START = 133;
const int ARCHER_DEATH_UP_END = 133;
const int ARCHER_DEATH_DOWN_START = 146;
const int ARCHER_DEATH_DOWN_END = 146;
